...
// `Relationship` and `InteractionKind` also exist, with different shapes,
// on Team 06 (creature)'s public API (src/sim/creature/relationships).
// Re-exported here under distinct names so both can coexist on the
// top-level src/sim barrel without an ambiguous-export collision.
